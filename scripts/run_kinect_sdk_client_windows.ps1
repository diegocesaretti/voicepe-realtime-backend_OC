...
cmd.exe /c "`"$Python`" -u local_clients\kinect_windows_client.py --input-backend kinect-sdk --sdk-bridge-exe `"$BridgeExe`" --sdk-snapshot-dir `"$SnapshotDir`" --output-device Altavoces --ws-url ws://127.0.0.1:8080/ --wake-word --wake-sound-ms 220 > `"$LogPath`" 2>&1"
